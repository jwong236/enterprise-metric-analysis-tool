...
# Write to file and clear sql_lines
with open("insert-teams-services-repos.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-teams-services-repos.sql")
...
# Write to file and clear sql_lines
with open("insert-lead-time-for-change.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-lead-time-for-change.sql")
...
# Write to file and clear sql_lines
with open("insert-blocked-task-time.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-blocked-task-time.sql")
...
# Write to file and clear sql_lines
with open("insert-deployment-frequency.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-deployment-frequency.sql")
...
# Write to file and clear sql_lines
with open("insert-open-issue-bug-count.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-open-issue-bug-count.sql")
...
# Write to file and clear sql_lines
with open("insert-refinement-changes-count.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-refinement-changes-count.sql")
...
# Write to file and clear sql_lines
with open("insert-retro-mood.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-retro-mood.sql")

# pull_request (30% chance per day)
for day in all_dates:
    if random.random() < 0.30:
        resolved_date = (day + timedelta(days=random.randint(1, 5))).strftime(
            "%Y-%m-%d"
        )
...
# Write to file and clear sql_lines
with open("insert-pull-request.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(sql_lines))
sql_lines.clear()
print("Wrote insert-pull-request.sql")
